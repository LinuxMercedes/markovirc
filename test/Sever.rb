...
class SentenceTest < Test::Unit::TestCase
  ...
  def test_latex_sentence
    ...
    e = %w(4Artist : 12 m3n Soundtrack 3 :: YouTube Shinedown - I'm advancing ... Doing (g^{y_i})^{x_i} I don't actually know who sits in front of draenor .)
    
    self.assert_sentence s, e
  end

  def test_url_sentence
